...
config :mu_identifier,
  ...
  default_session_lifetime_seconds: CH.system_integer("DEFAULT_SESSION_LIFETIME_SECONDS"),
  allow_session_clear_header: CH.system_boolean("MU_ALLOW_SESSION_CLEAR_HEADER", true),
  session_lifetime_strategy: CH.system_atom("SESSION_LIFETIME_STRATEGY", :clear_mu_session_id),
  session_keepalive_seconds: CH.system_integer("SESSION_KEEPALIVE_SECONDS"),
  session_keepalive_strategy: CH.system_atom("SESSION_KEEPALIVE_STRATEGY", :clear_mu_auth_allowed_groups),
  invalid_session_strategy: CH.system_atom("INVALID_SESSION_STRATEGY", :clear_mu_session_id),
