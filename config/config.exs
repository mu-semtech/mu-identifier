...
config :mu_identifier,
  ...
  session_lifetime_strategy: CH.system_atom("SESSION_LIFETIME_STRATEGY", :clear_session),
  session_keepalive_seconds: CH.system_integer("SESSION_KEEPALIVE_SECONDS"),
  session_keepalive_strategy: CH.system_atom("SESSION_KEEPALIVE_STRATEGY", :clear_allowed_groups),
